...
function findWorkspaceRoot(startDir) {
  ...
  // Fallback: dùng projectRoot khi không tìm thấy pnpm-workspace.yaml
  // (trường hợp mobile nằm trong project thường, không phải pnpm workspace)
  console.warn("[build] pnpm-workspace.yaml not found, using project root as workspace root");
  return startDir;
}
